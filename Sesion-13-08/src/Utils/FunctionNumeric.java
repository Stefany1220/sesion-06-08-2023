...
public class FunctionNumeric {
    ...
    /* public Double InputDoubleNumericPositiveScanner(String digite_el_promedio_del_estudiante) {
    throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }*/

    public int InputIntNumericPositiveScanner(String digite_el_número_de_materias_reprobadas) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
